...
function setup() {
 ...
 ground2 = new Stand(600,550,500,15)
 ground3 = new Stand(1250,400,500,15)

 box1a = new Box(380,545,45,70);
 box1b = new Box(440,545,45,70);
 box1c = new Box(500,545,45,70);
 box1d = new Box(560,545,45,70);
 box1e = new Box(620,545,45,70);
 box1f = new Box(680,545,45,70);
 box1g = new Box(740,545,45,70);
 box1h = new Box(800,545,45,70);
 
  box2a = new Box(410,415,45,70);
  box2b = new Box(470,415,45,70);
  box2c = new Box(530,415,45,70);
  box2d = new Box(600,415,45,70);
  box2e = new Box(670,415,45,70);
  box2f = new Box(730,415,45,70);
  box2g = new Box(800,415,45,70);
...
slingshot= new SlingShot(ball,{x:120,y:250})
